...
class Bitome:
    ...
    def one_hot_encode_tu_promoters(self, local_align: bool = False,
                                    ...
                                    tss_radius: int = 3, box_10_l_radius: int = 6,
                                    box_10_r_radius: int = 6, box_35_l_radius: int = 6,
                                    box_35_r_radius: int = 6, shift_odd_len_upstream: bool = True
                                    ) -> pd.DataFrame:
        """
        ...
        if local_align:
            ...
            for tu_row in tu_table_local_align.itertuples():
                ...
                b10_u_l, b10_u_r = tu_row.box_10_left - box_10_l_radius, tu_row.box_10_left + box_10_l_radius
                b10_d_l, b10_d_r = tu_row.box_10_right - box_10_r_radius, tu_row.box_10_right + box_10_r_radius
                b35_u_l, b35_u_r = tu_row.box_35_left - box_35_l_radius, tu_row.box_35_left + box_35_l_radius
                b35_d_l, b35_d_r = tu_row.box_35_right - box_35_r_radius, tu_row.box_35_right + box_35_r_radius
                #b35_l, b35_r = tu_row.box_35_left - box_35_radius, tu_row.box_35_right + box_35_radius
                ...
                box_10_u_oh = self.one_hot_encode_sequence(b10_u_l, b10_u_r, tu_row.strand)
                box_10_u_oh.index = reindex_one_hot(box_10_u_oh.index, box_10_l_radius, prefix='-10_u_')
                box_10_d_oh = self.one_hot_encode_sequence(b10_d_l, b10_d_r, tu_row.strand)
                box_10_d_oh.index = reindex_one_hot(box_10_d_oh.index, box_10_r_radius, prefix='-10_d_')
                box_35_u_oh = self.one_hot_encode_sequence(b35_u_l, b35_u_r, tu_row.strand)
                box_35_u_oh.index = reindex_one_hot(box_35_u_oh.index, box_35_l_radius, prefix='-35_u_')
                box_35_d_oh = self.one_hot_encode_sequence(b35_d_l, b35_d_r, tu_row.strand)
                box_35_d_oh.index = reindex_one_hot(box_35_d_oh.index, box_35_r_radius, prefix='-35_d_')
                ...
                full_oh_row = pd.concat([tss_oh, box_10_u_oh, box_10_d_oh, box_35_u_oh, box_35_d_oh])
